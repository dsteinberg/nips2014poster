...
\begin{tikzpicture}
    [	
		...
		fact/.style ={rectangle,draw=black,fill=black,thick,inner sep=0pt,
                       minimum size=\pointsize},
    ...
    \node[fact]     (g0)    [below=of q0, label=right:$g_0$]          {};
    \node[fact]     (g1)    [below=of q1, label=right:$g_1$]          {};
    \node[fact]     (g2)    [below=of q2, label=right:$g_2$]          {};
    \node[fact]     (g3)    [below=of q3, label=right:$g_3$]          {};

    \node[odist]    (x0)    [below=of g0]        {$\obss_{0}$};
    \node[odist]    (x1)    [below=of g1]        {$\obss_{1}$};
    \node[odist]    (x2)    [below=of g2]        {$\obss_{2}$};
    \node[odist]    (x3)    [below=of g3]        {$\obss_{3}$};
