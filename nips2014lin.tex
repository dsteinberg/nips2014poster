...
\begin{table}[tb]
    ...
    \caption[]{The EGP, UGP and a competing method~\cite{Opper2009} with
...
\begin{table}[tb]
    ...
    \caption[]{We can also use the EGP and UGP for \emph{classification}
        ...
        %Initialising the observations noise, $\lvar$, to a small value
        %($10^{-14}$) improves our GPs' performance.
    }
